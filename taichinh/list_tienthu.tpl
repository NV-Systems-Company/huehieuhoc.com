...
<br>			
<font class=sub_Title>Ho&#7841;t &#273;&#7897;ng t&agrave;i ch&iacute;nh Ti&#7873;n Thu</font><br> 
<form name="thu" method="POST" action="index.php?fod=taichinh&act=lst_thu&exe=taich&code=list" onsubmit="return check_find(this)">
...
?>
		  <tr class="row_<?=$i%2?>">
			...
			<td width="155"><?=$thuchi["nguoi_nop_nhan"][$i]  ?></td>
...
?>
		 <tr>
		  	<td class="content" align="center" colspan="6">Kh&ocirc;ng t&igrave;m th&#7845;y th&ocirc;ng tin c&#7847;n t&igrave;m!</td>
		  </tr>
<? } ?>
		</table>
    </td>
