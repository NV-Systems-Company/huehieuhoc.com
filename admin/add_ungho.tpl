...
<br>
<form name="add_ungho" method="post" action="index.php?fod=ad&act=add_uh&exe=uh&code=addsm" enctype="multipart/form-data">
<table width="400" border="0" cellpadding="2" cellspacing="0" bgcolor="#CCCCCC">
	<tr>
		<td class="title1" colspan="2" align="center">C&#7853;p nh&#7853;t danh s&aacute;ch &#7910;ng h&#7897;</td>
	</tr>
	<tr>
		<td colspan="2">&nbsp; </td>
	</tr>			
