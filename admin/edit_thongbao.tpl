...
<br>
<font class=box_Subject>THAY &#272;&#7892;I TH&Ocirc;NG B&Aacute;O</font>
<br>
<form method="POST" action="index.php?fod=ad&act=edit_tb&exe=tb&code=editsm&id=<?=$id?>" enctype="multipart/form-data">
<table border="0" width="481" cellspacing="5" cellpadding="0">
  <tr>
    ...
    <td width="376"><textarea class="form" name="thong_bao" cols="54" rows="2"><?=$thong_bao?></textarea>
	</td>
  </tr>
  <tr>
  	<td align="right" valign="top" class="name_item"><font class="yeucau">*</font>File th&ocirc;ng b&aacute;o:</td>
    <td class="name_item">
		<input class=form type="file" name="file_tb" size="43"><br>
