...
<br>
<form name="add_ungho" method="post" action="index.php?fod=ad&act=add_chi&exe=thuchi&code=addsm" enctype="multipart/form-data">
<input name="loaiphieu" type="hidden" value="C">
<table width="400" border="0" cellpadding="2" cellspacing="0" bgcolor="#D7FFEC">
	<tr>
		<td class="title1" colspan="2" align="center">Ph&aacute;t sinh Chi </td>
	</tr>
	<tr>
		<td colspan="2">&nbsp; </td>
	</tr>	
