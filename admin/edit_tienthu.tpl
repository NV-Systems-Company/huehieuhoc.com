...
<br>
<form name="add_ungho" method="post" action="index.php?fod=ad&act=edit_thu&exe=thuchi&code=editsm&id=<?=$id_thuchi?>" enctype="multipart/form-data">
<input name="loaiphieu" type="hidden" value="T">
<table width="400" border="0" cellpadding="2" cellspacing="0" bgcolor="#FDFFCA">
	<tr>
		<td class="title1" colspan="2" align="center">Thay &#273;&#7893;i ph&aacute;t sinh Thu </td>
	</tr>
	<tr>
		<td colspan="2">&nbsp; </td>
	</tr>	
	...
	<tr>
	  <td class=textbody width="40%" align="right"><font class="yeucau">*</font>Ng&#432;&#7901;i n&#7897;p:</td>
