...
<?php
$act_temp 	 = isset($act_temp) 		? $act_temp 		: 'idx';
?>
<!-------------->
<center>
<br>
...
<?}?>
<!--- ---->
<form name="editmember" method="post" action="index.php?fod=ad&act=<?=$act_temp?>&exe=editmem&code=editsm" enctype="multipart/form-data">
		...
		<td width="100%">
			<table border="0" width="100%" cellspacing="0" cellpadding="3" bgcolor="#FFFFFF">
				<tr>
					<td class="content" colspan="2"align="center">	
						<table border="0" width="80" height="100" cellspacing="0" cellpadding="0">
						 ...
						 Gia nh&#7853;p ng&agrave;y <input class="form" value="<?=$user['join_date']?>" type="text" name="join_date" size="10">
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td width="66%"><input class="form" value="<?=$user['namsinh']?>" type="text" name="namsinh" size="10"></td>
				</tr>
				<tr>
				...
				<tr>
				  	<td class=textbody width="34%" align="right">&#272;&#7897; &#432;u ti&ecirc;n</td>
					<td width="66%"><input class="form" name="order_num" value="<?=$user['order_num']?>" type="text" size="8"></td>
				</tr>
				<tr>
					<td width="34%">&nbsp;</td>
