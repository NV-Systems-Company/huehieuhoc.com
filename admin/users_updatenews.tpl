...
<br>
<br>
<font class=Title>Th&agrave;nh vi&ecirc;n c&oacute; quy&#7873;n c&#7853;p nh&#7853;t tin t&#7913;c</font>
<br>
<br>
...
<?php
if ($users_upnw_count>0){
	for ($i=0;$i<$users_upnw_count;$i++){
?>
		  <tr>
			<td class="content" width="365"><?=$users_upnw["realname"][$i]?></td>
			<td class="content" width="76"><a href="index.php?fod=ad&act=memupnw&exe=memupnw&code=del&id=<?=$users_upnw['id'][$i]?>">X&oacute;a b&#7887;</a></td>
		  </tr>
<?php
	}
}
...
<br>
<br>
<form name="update_news" method="post" action="index.php?fod=ad&act=memupnw&exe=memupnw&code=add" enctype="multipart/form-data" onsubmit="return check_form(this)">
<table width="375" border="0" cellpadding="2" cellspacing="0" bgcolor="#CCCCCC">
	<tr>
		<td class="title1" colspan="2" align="center">Th&ecirc;m th&agrave;nh vi&ecirc;n quy&#7873;n c&#7853;p nh&#7853;t tin t&#7913;c</td>
	</tr>
	<tr>
		<td colspan="2">&nbsp; </td>
	</tr>
