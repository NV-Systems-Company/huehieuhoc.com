...
<br>
<p>
<a class="menu_admin" href="index.php?fod=ad&act=add_chi&exe=thuchi&code=add">Ph&aacute;t sinh ti&#7873;n Chi </a> 
&nbsp;&nbsp;
...
<br>			
<font class=Title>Qu&#7843;n l&yacute; ti&#7873;n Chi </font>
<p>S&#7889; li&#7879;u &#273;&#432;&#7907;c c&#7853;p nh&#7853;t m&#7899;i nh&#7845;t v&agrave;o l&uacute;c: <?=$last_update?></p>
<br> 
<form name="thu" method="POST" action="index.php?fod=ad&act=lst_chi&exe=thuchi&code=list" onsubmit="return check_find(this)">
    ...
    <td>
		<table border="0" width="460" cellspacing="1" cellpadding="3">
		  <tr>
			...
			<td class="title1" width="58">Phi&#7871;u chi </td>
			<td class="title1" width="57">Ng&agrave;y</td>
			<td class="title1" width="108">L&yacute; do Chi </td>
			<td class="title1" width="80" align="right">S&#7889; ti&#7873;n</td>
			<td class="title1" width="31" align="right">&#272;VT</td>
			<td class="title1" width="58" align="right">&nbsp;</td>
		  </tr>
<?php
if ($thuchi_count>0){
...
?>
		  <tr class="row_<?=$i%2?>" title="<?=$thuchi['nguoi_capnhat'][$i]?>">
			<td width="18" align="right"><?=($thuchi_per_page*($page-1))+$i+1?></td>
			<td width="58"><?=$thuchi["so_phieu"][$i]?></td>
			<td width="57"><?=$thuchi["ngayphatsinh"][$i]?></td>
			<td width="108"><?=$thuchi["lydo"][$i]  ?></td>
			<td width="80" align="right"><?=$thuchi["sotien"][$i]  ?></td>
			<td width="31" align="right"><?=$thuchi["donvitien"][$i]  ?></td>
			<td width="58" align="right"><a href="index.php?fod=ad&act=edit_chi&exe=thuchi&code=edit&id=<?=$thuchi['id_thuchi'][$i]?>">S&#7917;a</a> : : <a href="index.php?fod=ad&act=lst_chi&exe=thuchi&code=del&id=<?=$thuchi['id_thuchi'][$i]?>">X&oacute;a</a></td>
		  </tr>
<?php
	}
}
